...
import { Scissors, Mail, Lock, Eye, EyeOff, User, ArrowRight } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center py-20 px-4">
        <Card variant="elevated" className="w-full max-w-md p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground font-body">Entre na sua conta para continuar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm text-muted-foreground font-body">Lembrar de mim</span>
              </label>
              <Link to="/esqueci-senha" className="text-sm text-primary hover:underline font-body">
                Esqueceu a senha?
              </Link>
            </div>
